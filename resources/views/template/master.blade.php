...
<div id = "home">
			...
			<div class="top_nav_left">
				...
				<div class="container-fluid">
					...
					<ul class="nav navbar-nav menu__list">
						...
						<li v-for = 'categoria in lista_categorias' class=" menu__item"><a class="menu__link"  @click = 'obtenerProductosCategoria(categoria)'>@{{categoria.cNombreCategoria}}</a></li>
					</ul>
					</div>
				</div>
				</nav>	
	...
	<div class="product-easy">
		<div class="container">
			...
			<div v-for = "producto in productos_categoria" class="col-md-3" class="card" style="width: 18rem;">
				<img class="card-img-top" src="..." alt="Card image cap">
					<div class="card-body">
					<h5 class="card-title">@{{producto.cNombreProducto}}</h5>
...
<script src = '/vuejs/app-home.js'></script>
</html>
